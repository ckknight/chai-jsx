    ...
    describe('equal', function () {
        describe('html components', function () {
            ...
            describe('that have different prop values', function () {
                ...
                it('throws the correct expected vs. actual', function () {
                    var x = React.createElement("div", { className: "alpha" });
                    var y = React.createElement("div", { className: "bravo" });
                    ...
                    try {
                        ...
                        errored = true;
                        expect(e.actual).to.contain('alpha');
                        expect(e.expected).to.contain('bravo');
                    }
    ...
    describe('include', function () {
        describe('only child', function () {
            it('passes', function () {
                ...
                var y = React.createElement(Child);
                expect(x).jsx.to.include(y);
            });
        });

        describe('multiple children, checking for one', function () {
            it('passes', function () {
                function Parent() {}
                function Child1() {}
                function Child2() {}
                ...
                var x = React.createElement(Parent, {},
                    React.createElement(Child1), React.createElement(Child2), React.createElement(Child3));
                var y = React.createElement(Child2);
                expect(x).jsx.to.include(y);
            });
        });

        describe('different child', function () {
            it('fails', function () {
                function Parent() {}
                function Child() {}
                function Other() {}
